...
@section('information')
    ...
    <li class="active"><a class="colorr" data-toggle="tab" href="#whatis">What is Financial Reporting</a></li>
...
<div class="tab-content  remove_border">
  <div id="whatis" class="tab-pane fade in active">
						  ...
						  When a business is set up in any form, there are numerous monetary transaction which should be recorded in maintained files so as to submit it to bodies like the Income Tax Department whenever required. The method of recoding and maintaining the files is called account maintenance. This seems to be a lengthy and hectic job but is very significant for any business. Significance can be measured at the time of evaluating the financial status of the business and while seeking the trust of investors. <br>
The problem in this function arises when businesses end up ignoring this duty and end up in legal troubles in the long run. Established businesses have well settled mechanisms for book keeping but it is a problem for the start up ventures who fail to do so. We provide you with the service where we help you in maintaining your accounts in the best ways by professionals who are qualified and skilled. Data maintained by you would be classified and analyzed. Reports for the same would be prepared which would be an asset for the company. 
