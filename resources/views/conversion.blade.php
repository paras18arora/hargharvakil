...
@section('information')
    ...
    <li class="active"><a class="colorr" data-toggle="tab" href="#whatis">What is Conversion</a></li>
...
<div class="tab-content  remove_border">
  <div id="whatis" class="tab-pane fade in active">
						  ...
						  Like law, no business is static forever. With time, the needs of a company changes and with every changing need, the structure of a company changes. No company is stuck with one corporate structure. The corporate law works on the principle which seeks the interest of businessmen and entrepreneurs.<br>
Converting a company from one business type to another requires the business owner to follow the procedure required by the company’s state of incorporation. There are many reasons a business owner may decide to convert a business from one type of business entity to another, including tax, management, and stock considerations. Private limited structures can be converted to public limited companies and it can also be converted into a One Person Company. Conversion is the way in which law fulfills the needs of the business and the same requires great caution and care. <br>
Be it a conversion from a partnership to a company or from a private limited to a company, we will advice you on the same and will help you with the procedure of conversion with ease and speed.  
