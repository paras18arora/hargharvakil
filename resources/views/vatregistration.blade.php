...
@section('information')
    ...
    <li class="active"><a class="colorr" data-toggle="tab" href="#whatis">What is VAT Registration</a></li>
...
<div class="tab-content  remove_border">
  <div id="whatis" class="tab-pane fade in active">
						  ...
						  A value added tax (VAT) is a consumption tax added to a product's sales price. It represents a tax on the "value added" to the product throughout its production process.<br>
VAT (Value Added Tax) is a form of indirect tax imposed only on goods sold within a particular state, which essentially means that the buyer and the seller needs to be in the same state. Only when tangible goods and products are sold, VAT can be imposed. VAT is governed by respective state Acts. Every state has a separate and distinct VAT act reserved for their state. Vat registration is compulsory for dealers having turnover exceeding Rs 5 lacs (or increased limit of Rs 10 lakhs in some states).<br>
Tax slab is different for every product and it is clearly classified that how much VAT has to be paid for each product. VAT is actually calculated as the difference between input tax and output tax.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VAT = Output Tax – Input Tax<br>
Where output tax is the tax received by the seller for sale of his goods and services and input tax is the tax paid by the seller for raw materials required to manufacture his goods and services.<br>
