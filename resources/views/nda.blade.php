...
@section('information')
    ...
    <li class="active"><a class="colorr" data-toggle="tab" href="#whatis">What is NDA</a></li>
...
<div class="tab-content  remove_border">
  <div id="whatis" class="tab-pane fade in active">
						  ...
						  Non-Disclosure Agreements (NDA) are another type of agreement which is essential for maintaining the confidentiality of information, data or even an idea expressed to another party. With emerging start-ups and innovations, it is very important to have a well drafted ‘NDA’ in place for a successful start to projects. <br>
This non-disclosure agreement is entered into by and between the undersigned parties on the date specified below. Where either Party possesses certain confidential proprietary information and either Party desires to prevent the unauthorized use and disclosure of its confidential proprietary information.<br>
NDA’s define the terms and conditions between you and your business partner, employee or any other third party for exchanging and using confidential information and materials
We provide you expert help in drafting your NDA’s professionally since it is one of the basic things required for startups specially. 
