...
@section('information')
    ...
    <li class="active"><a class="colorr" data-toggle="tab" href="#whatis">What is Policies and Disclaimers</a></li>
...
<div class="tab-content  remove_border">
  <div id="whatis" class="tab-pane fade in active">
						   ...
						   Policies and disclaimers are app-related agreements where information is displayed and consent is taken from the user as to the terms of service and the use of information. We shall use the best of policies and conditions to keep the application owners protected from legal hassles on the use of their services by users. <br>
Most people online like their privacy and like to keep their information to themselves. The thought of giving out your Social Security number or email and having it be used in a way you don’t approve of scares many Internet users. Privacy policies let all of your readers or users know exactly what you do with their data.  If you don’t plan to do anything with it, it is good for your readers to know that.  This might make them more likely to sign up for your service or whatever your website does. A disclaimer is generally any statement intended to specify or delimit the scope of rights and obligations that may be exercised and enforced by parties in a legally recognized relationship. In contrast to other terms for legally operative language, the term disclaimer usually implies situations that involve some level of uncertainty, waiver, or risk.
 However, writing your own privacy policy or disclaimer requires great caution and care and we at Har Ghar Vakil would get your policy and disclaimer drafted professionally in no time.
