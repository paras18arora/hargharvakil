...
@section('information')
				...
				<div class="row">
					<div class="col-xs-12 banner-box">
						<header class="banner-heading">
							<h1>DIRECTOR IDENTIFICATION NUMBER</h1>
    ...
    <li class="active"><a class="colorr" data-toggle="tab" href="#whatis">What is DIN</a></li>
...
<div class="tab-content  remove_border">
  <div id="whatis" class="tab-pane fade in active">
						  ...
						  Director Identification Number (DIN) is a unique identification number given to an existing or a potential Director of any company which is incorporated.  DIN came into existence after the insertion of the section 266A & 266B of the Companies Act, 1956 (as amended vide Act No 23 of 2006). The main purpose of introducing Director Identification Number (DIN) was to keep a Date base of the Directors of the incorporated companies and to keep complete information about the Directors so that they don’t cheat anyone and in case they do, can be traceable.<br>
Director Identification Number (DIN) not only helps fixing the identity of the Director but also relates his participation in others companies, past and present. In case any change of address or particular is faced by the DIN holder, they are supposed to inform the central government about the same. So this keeps the database ‘live’ always.<br>
...
Certain documents like a proof of identity, proof of residence, proof of date of birth, affidavit in the case of single name as per the guidelines and so on are required. It is a simple process but requires attention to minute details and the same can be done by use in the best possible manner. 
